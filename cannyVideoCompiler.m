function cannyVideoCompiler(ogVidFile, ogImageMat, ogFrameRate, cannyVidFileName, cannyImageMat)
% Inputs: 
...
outputVideo = VideoWriter(cannyVidFileName, 'MPEG-4');
...
for k = 1:frameCount
    ...
    frame = im2uint8(cannyImageMat{k}); 
